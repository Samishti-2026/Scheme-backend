...
let SchemesController = class SchemesController {
    schemesService;
    constructor(schemesService) {
        this.schemesService = schemesService;
    }
    findAll(region, type, search, status) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], SchemesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:returntype", void 0)
], SchemesController.prototype, "create", null);
__decorate([
    (0, common_1.Put)(':id'),
    (0, roles_decorator_1.Roles)('Admin', 'Executive', 'Manager'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", void 0)
], SchemesController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], SchemesController.prototype, "remove", null);
exports.SchemesController = SchemesController = __decorate([
    (0, swagger_1.ApiTags)('schemes'),
    (0, swagger_1.ApiHeader)({ name: 'x-tenant-id', required: true }),
    (0, common_1.Controller)('schemes'),
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard),
    __metadata("design:paramtypes", [schemes_service_1.SchemesService])
], SchemesController);
